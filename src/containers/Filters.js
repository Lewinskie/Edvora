          ...
          <CardContent>
              ...
              <form action="#">
                  <FormControl variant="outlined" className={classes.formControl}>
                      <Select onChange={selectActiveProduct} value={activeProduct.date || ""} label="Products">
                  ...
                  <FormControl variant="outlined" className={classes.formControl}>
                      <Select onChange={selectActiveState} value={activeState.state || ""} label="States">
                          {products.length > 0 ? getStates(activeProduct).map((option) => (
